...
module.exports = cube = {
    ...
    create : function (options, done) {
        token(function (err, access_token) {
            ...
            .end(function (err, res) {
                console.log('cbue create resp', err, res.body);
    ...
    add_dataset : function (options, done) {
        token(function (err, access_token) {
            ...
            console.log('add dataset', endpoints.cube.add);
    ...
    add_mask : function (data, done) {
        token(function (err, access_token) {
            if (err) return done('No access token.');

            console.log('########### ADD MASK ################', endpoints.cube.mask);
            data.access_token = access_token;
