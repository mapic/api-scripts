...
ops.push(function (callback) {
    ...
    fs.mkdirs(tmp.local_folder, function (err) {
        ...
        // debug
        tmp.ftp_files_to_add = _.sampleSize(tmp.ftp_files_to_add, 2);
...
ops.push(function (callback) {
    ...
    console.log('Replacing', _.size(sets), 'datasets.');
    ...
    ops.push(function (callback) {
        ...
        token(function (err, access_token) {
            ...
            .end(function (err, response) {
                ...
                json.options.project = project.uuid;
        ...
        token(function (err, access_token) {
            ...
            var layer = {
                data : { 
                    ...
                    cube : tmp.updated_cube
                },
                // layer : json.options.layer,
                projectUuid : json.options.project,
                access_token : access_token,
                title : 'FTP Synced layer'
            };
...
ops.push(function (callback) {
    token(function (err, access_token) {
        ...
        // get last day 
        var lastDate = _.maxBy(cube.datasets, function (d) {
            return d.timestamp;
        });
        var dayOfYear = lastDate ? moment(lastDate.timestamp).dayOfYear() : 365;
